...
<body>
    ...
    <form id="FormCadastro" name="FormCadastro" method="post">
        ...
        <input type="text" name="cidade" id="cidade" placeholder="Digite sua cidade" required><br>
        <input type="text" name="bairro" id="bairro" placeholder="Digite seu bairo" required><br>
